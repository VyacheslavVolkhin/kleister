            ...
            dist: {
                ...
                options: {
                    ...
                    sections: {
                        ...
                        catalogmain: '<%= fixturesPath %>/**/catalogmain.html',
                        catalogmain02: '<%= fixturesPath %>/**/catalogmain02.html',
                        catalogsecond: '<%= fixturesPath %>/**/catalogsecond.html',
                        catalogsecond02: '<%= fixturesPath %>/**/catalogsecond02.html',
                    },
                    data: {
                        version: "0.1.0",
                        title: "test",
